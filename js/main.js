...
// });
    ...
    // $('nav#dropdown').meanmenu({ siteLogo: "<a href='' class='logo-mobile-menu'><img src='img/prabhat_mobile_new_logo_1.png' /></a> <a href='' class='btn btn-outline-primary text-right'>Call Now </a>" });
    ...
    if ($('#googleMap').length) {
        ...
        var initialize = function() {
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(25.200953, 75.834913)
